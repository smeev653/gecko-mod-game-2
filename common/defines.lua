...
NDiplomacy = {
	...
	DEFENDER_AE_MULT = 0.5, 					-- _DDEF_DEFENDER_AE_MULT_ (Infamy multiplied by this for defenders in peace treaties, unless the CB is "mutual" )
...
NEconomy = {
	...
	EDICTS_DURATION_MONTHS = 6,				-- months lastin at least.
	...
	LAND_TECH_MERC_MAINTENANCE_IMPACT = 0.1, 			-- % each tech increases it.
	...
	TRADE_WIND_STRENGTH = 0,						-- _EDEF_TRADE_WIND_STRENGTH_
...
NMilitary = {
	...
	LOOTED_SCALE = 3,								-- Scaling value from province development to number of ducats it contains.
...
NAI = {
	...
	MAX_SAVINGS = 5, -- AI will keep a maximum of this * their monthly income in long-term savings
	ADVISOR_BUDGET_FRACTION = 0.66, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	CORRUPTION_BUDGET_FRACTION = 1, -- AI will spend a maximum of this fraction of monthly income on rooting out corruption
...
NGovernment = {
	...
	YEARLY_TRIBAL_ALLEGIANCE_MAX = -2.0,
	TRIBAL_ALLEGIANCE_HUMILIATE = 50.0, -- TA gained from doing Humiliate or Show Strength in a war.
